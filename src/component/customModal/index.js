...
const CustomModal = (props) => {
  ...
  return (
    <Modal open={props.open} className="flex-center">
      ...
      >
        <Box className="custom-modal-container flex-column start-flex p-20 pb-0 " style={props.width ? { width: props.width } : {}}>
          <Box
          ...
          >
            ...
            <Box className="w-100" style={{ marginBottom: props.warn?"30px":"20px", minHeight: "50px" }}>
